...
GRLIB_SetupParamMenu = {
    ...
    private _color_west = getArray (configFile >> "CfgMarkerColors" >> "ColorBlue" >> "color") call BIS_fnc_colorConfigToRGBA;
    private _color_east = getArray (configFile >> "CfgMarkerColors" >> "ColorRed" >> "color") call BIS_fnc_colorConfigToRGBA;
