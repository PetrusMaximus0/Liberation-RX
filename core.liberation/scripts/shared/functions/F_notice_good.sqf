...
private _msg = format ["<t color='#4BC9B0' shadow='2' size='1.75'>The Good</t><br/>"];
_msg = _msg + "<t color='#777777'>------------------------------</t><br/>";
_msg = _msg + format ["Best Civilian relation on <t color='#008000'>%1</t> at %2<br/><br/>", worldname, _datestring];
...
private _ind = "";
private _icon = "<img image='\a3\ui_f\data\igui\cfg\simpletasks\types\defend_ca.paa'/>";
